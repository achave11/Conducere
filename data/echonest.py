...
#    try:
    next_track = sp.audio_features(playlist_tracks[i])
    for next_tracks in next_track:
	analysis = sp._get(next_tracks['analysis_url'])
...
#        next_track = next_track.audio_features()
#      analysis.append(next_track)
#    except Exception:
